    ...
    <head>
        ...
        <script>
            $(function () {
                ...
                $("#add_new_schedule").on("click", function (e) {
                    const tgtUniqueId = $(".tgt-unique_id").val();
                    const tgtUsrName = $(".tgt-usr_name").val();
                    const tgtUsrId = $(".tgt-usr_id").val();
                    
                    // Set the correct data-url attribute with user_params
                    if (tgtUniqueId && tgtUsrName && tgtUsrId) {
                        $(this).attr('data-url', '/record/user/dialog/usr_pln_new_edit_dialog.php?user_params=' + encodeURIComponent(tgtUniqueId));
                    } else {
                        $(this).attr('data-url', '/record/user/dialog/usr_pln_new_edit_dialog.php?id=');
                    }
                });
            });
                    ...
                    <div id="subpage">
                        <div id="user-schedule" class="nursing schedule_info">
                            ...
                            <!--/// 検索エリア_START ///-->
                                ...
                                <!-- 予定追加：start -->
                                <div class="btn_box">
                                    <span id="add_new_schedule" class="modal_open btn add add-op add2 display_part" data-url="/record/user/dialog/usr_pln_new_edit_dialog.php?id=" data-dialog_name="dynamic_modal" style="width:130px;">予定追加</span>
                                </div>
