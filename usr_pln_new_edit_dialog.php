...
$userIdParam = filter_input(INPUT_GET, 'user_params');
...
<div class="dynamic_modal new_default sched_default displayed_part cancel_act" style="height:600px;width:950px!important;overflow: scroll!important;overflow-y: auto;overscroll-behavior-y: contain;top:60%;">
    ...
    <div class="s_detail">
        ...
        <div class="box1">
            ...
            <?php if ($userIdParam && isset($userList[$userIdParam])) : ?>
                <span class="user_res"><?= $userList[$userIdParam]['name'] ?></span>
                <input type="hidden" name="<?= $mainPrefix ?>[user_id]" value="<?= $userList[$userIdParam]['unique_id'] ?>">
                <span class="label_t">(利用者ID: <?= $userList[$userIdParam]['other_id'] ?>)</span>
            <?php else : ?>
